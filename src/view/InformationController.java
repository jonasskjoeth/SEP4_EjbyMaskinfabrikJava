...
public class InformationController
{
  ...
  {
    InformationTable selectedInformation = informationTableView.getSelectionModel()
        .getSelectedItem();
  ...
  public void updateView()
  {
    ...
    informationTableView.setItems(
        viewHandler.getConnection().retrieveInformationTable());

  }

  // This method is a work-in-progress of the delete button of which was meant
  ...
  public void deleteButtonClicked()
  {
    ...
    if (selectedInformation != null)
    {
      int selectedId = selectedInformation.getId();
      DatabaseConnector databaseConnector = new DatabaseConnector();
      databaseConnector.connect("kandula.db.elephantsql.com", 5432, "ectwvevf",
          "AnbDAZ4iNpY4toS8S4Cg27JwPN-pk2LW");
      databaseConnector.deleteInformation(selectedId);
  ...
  public void history()
  {
    viewHandler.changeScene(ViewHandler.HISTORY);
  }
}
